 ...
 * @author bernard
 */
public class MoneyJarsBaseService implements BaseService<MoneyJar> {
    public static final String TAG = MoneyJarsBaseService.class.getSimpleName();

    private JdbcConnection jdbcConnection;
    private ConfigureDb db;
    private Properties prop;

    public MoneyJarsBaseService() {
