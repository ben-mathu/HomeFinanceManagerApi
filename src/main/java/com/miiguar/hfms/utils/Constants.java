...
public class Constants {
    ...
    // public static final String BASE_URL = "http://localhost:8080/hfms/api/";
    ...
    // Patterns
    private static final String usernameRequiredPattern = "\\[]\\(\\)=,\"/?@:;";
    ...
    public static final Pattern VALID_PASSWORD_2SC = Pattern.compile("[ !\"#$%&'£()*+,\\-./:;<=>?@^_`{|}~]{2,}");
    public static Boolean VALID_PASSWORD = false;

    public static String isUsernameValid(String username) {
        String usernameResp = "Your username should have these properties:</br>" +
    ...
    public static String isPasswordValid(String password) {
        ...
        if (password.length() < 8) {
            sb.append("- At least 8 characters</br>");
        }
        ...
        if (!VALID_PASSWORD_2SC.matcher(password).find()) {
            sb.append("- At least 2 special characters</br>");
        }
