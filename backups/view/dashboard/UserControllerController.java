...
public class UserControllerController extends BaseController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        BufferedReader streamReader = conn.getReader(URL.GET_USER_DETAILS + requestParam, token, "GET");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String userId = req.getParameter(DbEnvironment.USER_ID);
        String incomeType = req.getParameter(DbEnvironment.INCOME_TYPE);
        String amount = req.getParameter(DbEnvironment.AMOUNT);
        ...
        BufferedReader streamReader = conn.getReader(incomeDto, URL.ADD_USER_INCOME + requestParam, token, "POST");
