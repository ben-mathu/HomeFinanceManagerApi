...
public class HouseholdControllerController extends BaseController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String userId = DbEnvironment.USER_ID + "=" + req.getParameter(DbEnvironment.USER_ID);
        ...
        BufferedReader streamReader = conn.getReader(URL.GET_HOUSEHOLD_MEMBERS + "?" + userId, token, "GET");
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        BufferedReader streamReader = conn.getReader(userHouseholdRel, URL.UPDATE_USER_HOUSEHOLD_REL, token, "PUT");
...
//        }
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        InitUrlConnection<UserHouseholdRel> conn = new InitUrlConnection<>();
        BufferedReader streamReader = conn.getReader(URL.UPDATE_USER_HOUSEHOLD_REL + "?" + householdId, token, "DELETE");
//        if (uri.endsWith("change-onwership")) {
//            streamReader = conn.getReader(userHouseholdRel, UPDATE_USER_HOUSEHOLD_REL, token, "PUT");
//        }
