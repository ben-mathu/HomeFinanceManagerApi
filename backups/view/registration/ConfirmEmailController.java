...
public class ConfirmEmailController extends BaseController {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (code.length() != 6) {
            ...
            BufferedReader streamReader = urlConnection.getReader(id, URL.CONFIRM, token, "POST");
            ...
            if (item != null) {
                if (item.getStatus() != 200) {
                    ...
                    req.getSession().setAttribute(DbEnvironment.USERNAME, user.getUsername());
                    req.getSession().setAttribute(DbEnvironment.EMAIL, user.getEmail());
                    req.getSession().setAttribute(DbEnvironment.USER_ID, user.getId());
